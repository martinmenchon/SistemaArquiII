...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppClassCeldaTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function Celda(instrucciones, tamano) {
      ...
      _createClass(Celda, [{
        ...
        value: function get(name) {
          for (var j = 0; j < this.instrucciones.length; j++) {
  ...
  function srcAppClassCicloTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function Ciclo(despacho, estaciones, unidadesFuncionales, celdas) {
        _classCallCheck(this, Ciclo);
  ...
  function srcAppClassEstacionTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function Estacion(instrucciones, tamano) {
        _classCallCheck(this, Estacion);

        this.instrucciones = instrucciones;
        this.tamano = tamano;
      }

      _createClass(Estacion, [{
        key: "ordenar",
        value: function ordenar(i) {
        ...
        key: "tengoLugar",
        value: function tengoLugar() {
          for (var j = this.instrucciones.length - 1; j >= 0; j--) {
        ...
        key: "nextEstacion",
        value: function nextEstacion(arr) {
          for (var j = this.instrucciones.length - 1; j >= 0; j--) {
        ...
        key: "estaOcupado",
        value: function estaOcupado(arr, reg1, reg2) {
  ...
  function srcAppClassInstruccionTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function Instruccion(name, tipo, estado, regDest, reg1, reg2) {
  ...
  function srcAppClassUnidadFuncionalTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function UnidadFuncional(instrucciones, tamano) {
  ...
  function srcAppClassDespachoTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function Despacho(instrucciones, tamano) {
      ...
      _createClass(Despacho, [{
        ...
        key: "ordenarInstrucciones",
        value: function ordenarInstrucciones() {
          var a = 5;
        }
      }]);
  ...
  function srcAppRobRobComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /** ROB component*/
    function () {
      function RobComponent() {
        _classCallCheck(this, RobComponent);
        ...
        var ciclo = new _class_Ciclo__WEBPACK_IMPORTED_MODULE_2__["Ciclo"](this.despacho, this.estaciones, this.unidadesFuncionales, this.celdas);
        this.ciclos = [ciclo];
      }

      _createClass(RobComponent, [{
        key: "terminado",
        value: function terminado(i, actual) {
        ...
        value: function generarRob() {
          ...
          if (this.visibleActual == 1) {
            ...
            var arrayEstacion;
            var arrayRob;
            var a = Number(this.unidadesFuncionales.tamano);
            var b = Number(this.estaciones.tamano);
            this.celdas.tamano = a + b;

            for (var j = 0; j < this.despacho.tamano; j++) {
            ...
            for (var _j = 0; _j < this.estaciones.tamano; _j++) {
            ...
            for (var _j2 = 0; _j2 < this.unidadesFuncionales.tamano; _j2++) {
            ...
            for (var _j3 = 0; _j3 < this.celdas.tamano; _j3++) {
            ...
            while (!this.terminado(this.ciclos[actual].celdas.instrucciones, actual)) {
              ...
              for (var _j4 = 0; _j4 < this.celdas.tamano; _j4++) {
                if (this.ciclos[actual].celdas.instrucciones[_j4].name != '') {
                  if (this.ciclos[actual].celdas.instrucciones[_j4].estado == 'X') {
                    if (this.ciclos[actual].celdas.instrucciones[_j4].cicloActual < this.ciclos[actual].celdas.instrucciones[_j4].tipo.ciclos) {
                      this.ciclos[actual].celdas.instrucciones[_j4].cicloActual++;

                      if (this.ciclos[actual].celdas.instrucciones[_j4].cicloActual == this.ciclos[actual].celdas.instrucciones[_j4].tipo.ciclos) {
                        this.ciclos[actual].celdas.instrucciones[_j4].estado = 'F';
                        var nombre = this.ciclos[actual].celdas.instrucciones[_j4].name;
                        var numero = nombre.substr(1);
                        var num = +numero;
                        this.instrucciones[num].estado = 'F';
                        var uf = this.ciclos[actual].unidadesFuncionales.get(this.ciclos[actual].celdas.instrucciones[_j4].name);
                        this.liberarCiclos(this.ciclos[actual].celdas.instrucciones[_j4]);
              ...
              for (var _j5 = 0; _j5 < this.celdas.tamano; _j5++) {
                if (this.ciclos[actual].celdas.instrucciones[_j5].segundaInstruccion != null) {
                  //if (this.puedoSacarSegundaInstruccion(actual, j) == 'Y') {
                  var nombre = this.ciclos[actual].celdas.instrucciones[_j5].segundaInstruccion.name;
                  this.ciclos[actual].celdas.instrucciones[_j5].segundaInstruccion = null;
                  var numero = nombre.substr(1);
                  var num = +numero;
                  this.instrucciones[num].estado = 'AFUERA'; //}
                }

                if (this.ciclos[actual].celdas.instrucciones[_j5].estado == 'F' && this.puedoSacarlo(actual, _j5) == 'Y') {
                  var nombre = this.ciclos[actual].celdas.instrucciones[_j5].name;
                  this.ciclos[actual].celdas.instrucciones[_j5].name = '';
                  this.ciclos[actual].celdas.instrucciones[_j5].estado = '';
                  var numero = nombre.substr(1);
                  var num = +numero;
                  this.instrucciones[num].estado = 'AFUERA';
                ...
                if (this.ciclos[actual].celdas.instrucciones[_j5].estado == 'I' && this.ciclos[actual].unidadesFuncionales.exists(this.ciclos[actual].celdas.instrucciones[_j5].name)) {
                  this.ciclos[actual].celdas.instrucciones[_j5].estado = 'X';
                }
              } //------------------------------------------------------------------------
              //Se inserta lo que se pueda insertar del  despacho


              for (var k = this.ciclos[actual].despacho.instrucciones.length - 1; k >= 0; k--) {
                if (this.ciclos[actual].despacho.instrucciones[k].name != '') {
                  ...
                  if (ufEmpty != -1) {
                    for (var _j6 = 0; _j6 < this.ciclos[actual].celdas.instrucciones.length; _j6++) {
                      if (this.ciclos[actual].celdas.instrucciones[_j6].name == '') {
                        this.ciclos[actual].unidadesFuncionales.instrucciones[ufEmpty] = this.ciclos[actual].despacho.instrucciones[k].clon();

                        if (this.ciclos[actual].celdas.instrucciones[_j6].segundaInstruccion == null) {
                          this.ciclos[actual].celdas.instrucciones[_j6] = this.ciclos[actual].despacho.instrucciones[k].clon();
                        } else {
                          var segunda = this.ciclos[actual].celdas.instrucciones[_j6].segundaInstruccion.clon();

                          this.ciclos[actual].celdas.instrucciones[_j6] = this.ciclos[actual].despacho.instrucciones[k].clon();
                          this.ciclos[actual].celdas.instrucciones[_j6].segundaInstruccion = segunda.clon();
                        }

                        this.ciclos[actual].celdas.instrucciones[_j6].estado = 'X';
                        this.ocuparRegistro(this.ciclos[actual].celdas.instrucciones[_j6]);
                    ...
                    if (erEmpty != -1) {
                      for (var _j7 = 0; _j7 < this.ciclos[actual].celdas.instrucciones.length; _j7++) {
                        if (this.ciclos[actual].celdas.instrucciones[_j7].name == '') {
                          this.ciclos[actual].estaciones.instrucciones[erEmpty] = this.ciclos[actual].despacho.instrucciones[k].clon();

                          if (this.ciclos[actual].celdas.instrucciones[_j7].segundaInstruccion == null) {
                            this.ciclos[actual].celdas.instrucciones[_j7] = this.ciclos[actual].despacho.instrucciones[k].clon();
                          } else {
                            var segunda = this.ciclos[actual].celdas.instrucciones[_j7].segundaInstruccion.clon();

                            this.ciclos[actual].celdas.instrucciones[_j7] = this.ciclos[actual].despacho.instrucciones[k].clon();
                            this.ciclos[actual].celdas.instrucciones[_j7].segundaInstruccion = segunda.clon();
                          }
                      ...
                      if (this.ciclos[actual].despacho.instrucciones[k].name != '') {
                        for (var m = 0; m < this.ciclos[actual].celdas.instrucciones.length; m++) {
              ...
              for (var _k = this.ciclos[actual].despacho.instrucciones.length - 1; _k >= 0; _k--) {
                if (this.ciclos[actual].despacho.instrucciones[_k].name == '' && indiceInstruccion < this.instrucciones.length) {
                  this.ciclos[actual].despacho.instrucciones[_k] = this.instrucciones[indiceInstruccion].clon();
                  indiceInstruccion++;
                }
        ...
        key: "puedoMeterlo",
        value: function puedoMeterlo(arg0) {
        ...
        key: "estaOcupado",
        value: function estaOcupado(name, reg1, reg2) {
          var nombre = reg1.substr(1);
          var numero = +nombre;
          ...
          if (reg2 != undefined) {
            ...
            if (this.registrosEstadoOcupado[numero2] == 'D' && this.registrosEstadoOcupado[numero] == 'D') {
              ...
              for (var l = 0; l < numeroInstruccion; l++) {
          ...
          if (this.registrosEstadoOcupado[numero] == 'D') {
            ...
            for (var _l = 0; _l < numeroInstruccion; _l++) {
              if (this.instrucciones[_l].regDest == reg1 && this.instrucciones[_l].estado == 'I') return 'Y';
            }
        ...
        key: "ocuparRegistro",
        value: function ocuparRegistro(arg0) {
        ...
        key: "liberarCiclos",
        value: function liberarCiclos(arg0) {
          if (arg0.tipo.name != 'ST') {
            var nombre = arg0.regDest.substr(1);
            var numero = +nombre;
        ...
        key: "puedoSacarSegundaInstruccion",
        value: function puedoSacarSegundaInstruccion(cicloActual, columna) {
        ...
        key: "puedoSacarlo",
        value: function puedoSacarlo(cicloActual, columna) {
        ...
        key: "ciclosDisabled",
        value: function ciclosDisabled() {
          return !this.instrucciones || this.instrucciones.length == 0;
        }
      }, {
        key: "addInstruccion",
        value: function addInstruccion() {
          if (this.instrucciones == undefined) this.instrucciones = [new _class_Instruccion__WEBPACK_IMPORTED_MODULE_7__["Instruccion"]('S' + 0, this.tipo, 'I', this.regDest, this.reg1, this.reg2)];else this.instrucciones[this.instrucciones.length] = new _class_Instruccion__WEBPACK_IMPORTED_MODULE_7__["Instruccion"]('S' + this.instrucciones.length, this.tipo, 'I', this.regDest, this.reg1, this.reg2);
        }
      }, {
        key: "verificarRegistros",
        value: function verificarRegistros() {
          this.instruccionesPorCicloDisabled = true;

          if (this.tipo.name == 'ST' || this.tipo.name == 'LD') {
            if (this.reg1 != null && this.regDest != null) document.getElementById("addBtn").disabled = false;
          } else if (this.reg1 != null && this.reg2 != null && this.regDest != null) document.getElementById("addBtn").disabled = false;
        }
      }, {
        key: "getReg1",
        value: function getReg1(tipo, reg) {
          if (tipo == 'LD') return '(' + reg + ')';else return reg;
        }
      }, {
        key: "getRegDest",
        value: function getRegDest(tipo, reg) {
          if (tipo == 'ST') return '(' + reg + ')';else return reg;
        }
      }, {
        key: "setTipo",
        value: function setTipo(value) {
          this.instruccionesPorCicloDisabled = true;
          ...
          try {
            for (var _iterator2 = this.tipos[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              var t = _step2.value;
          ...
          if (this.tipo.name == 'ST' || this.tipo.name == 'LD') {
            ...
            if (this.reg1 == null || this.reg2 == null || this.regDest == null) document.getElementById("addBtn").disabled = true;
            if (this.reg1 != null && this.reg2 != null && this.regDest != null) document.getElementById("addBtn").disabled = false;
          }
        }
      }]);
