...
/* harmony import */ var _rob_rob_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./rob/rob.component */ "./src/app/rob/rob.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        declarations: [
            ...
            _rob_rob_component__WEBPACK_IMPORTED_MODULE_7__["RobComponent"]
        ],
        imports: [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Celda", function() { return Celda; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
class Celda {
    ...
    clon() {
        ...
        if (this.tamano == undefined)
            this.tamano = this.instrucciones.length;
        return new Celda(instruccionesClon, this.tamano);
    }
    get(name) {
        for (let j = 0; j < this.instrucciones.length; j++) {
            if (this.instrucciones[j].name == name)
                return j;
            if (this.instrucciones[j].segundaInstruccion != null)
                if (this.instrucciones[j].segundaInstruccion.name == name)
                    return j;
        }
        return -1;
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Ciclo", function() { return Ciclo; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Estacion", function() { return Estacion; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
class Estacion {
    ...
    nextEstacion(arr) {
        for (let j = this.instrucciones.length - 1; j >= 0; j--) {
            if (this.instrucciones[j].name != '') {
                if ((this.instrucciones[j].tipo.name == 'ST') && (this.estaOcupado(arr, this.instrucciones[j].reg1, this.instrucciones[j].regDest) == 'N'))
                    return j;
                else if ((this.instrucciones[j].tipo.name == 'LD') && (this.estaOcupado(arr, this.instrucciones[j].reg1) == 'N'))
                    return j;
                else if (this.estaOcupado(arr, this.instrucciones[j].reg1, this.instrucciones[j].reg2) == 'N')
                    return j;
            }
        }
        return -1;
...
class Instruccion {
    ...
    clon() {
        ...
        if (this.segundaInstruccion != null)
            instruccionClon.segundaInstruccion = this.segundaInstruccion.clon();
...
class UnidadFuncional {
    ...
    get(a) {
        for (let j = 0; j < this.instrucciones.length; j++) {
            if (this.instrucciones[j].name == a)
                return j;
        }
...
class Despacho {
    ...
    get() {
        return { instrucciones: this.instrucciones, tamano: this.tamano };
    }
...
class Tipo {
    ...
    clon() {
        var tipo = new Tipo(this.name, this.ciclos);
        //tipo.ciclos = this.ciclos;
        return tipo;
    }
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RobComponent", function() { return RobComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _class_Ciclo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../class/Ciclo */ "./src/app/class/Ciclo.ts");
/* harmony import */ var _class_despacho__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../class/despacho */ "./src/app/class/despacho.ts");
/* harmony import */ var _class_UnidadFuncional__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../class/UnidadFuncional */ "./src/app/class/UnidadFuncional.ts");
/* harmony import */ var _class_Celda__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../class/Celda */ "./src/app/class/Celda.ts");
/* harmony import */ var _class_Estacion__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../class/Estacion */ "./src/app/class/Estacion.ts");
/* harmony import */ var _class_Instruccion__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../class/Instruccion */ "./src/app/class/Instruccion.ts");
/* harmony import */ var _class_tipo__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../class/tipo */ "./src/app/class/tipo.ts");
...
class RobComponent {
    ...
    generarRob() {
        ...
        if (this.visibleActual == 1) {
            ...
            for (let j = 0; j < this.despacho.tamano; j++) {
                if (arrayDespacho == undefined)
                    arrayDespacho = [new _class_Instruccion__WEBPACK_IMPORTED_MODULE_7__["Instruccion"]("", new _class_tipo__WEBPACK_IMPORTED_MODULE_8__["Tipo"]('', 1), "", "", "", "")];
                else
                    arrayDespacho.push(new _class_Instruccion__WEBPACK_IMPORTED_MODULE_7__["Instruccion"]("", new _class_tipo__WEBPACK_IMPORTED_MODULE_8__["Tipo"]('', 1), "", "", "", ""));
            }
            for (let j = 0; j < this.estaciones.tamano; j++) {
                if (arrayEstacion == undefined)
                    arrayEstacion = [new _class_Instruccion__WEBPACK_IMPORTED_MODULE_7__["Instruccion"]("", new _class_tipo__WEBPACK_IMPORTED_MODULE_8__["Tipo"]('', 1), "", "", "", "")];
                else
                    arrayEstacion.push(new _class_Instruccion__WEBPACK_IMPORTED_MODULE_7__["Instruccion"]("", new _class_tipo__WEBPACK_IMPORTED_MODULE_8__["Tipo"]('', 1), "", "", "", ""));
            }
            for (let j = 0; j < this.unidadesFuncionales.tamano; j++) {
                if (arrayUnidad == undefined)
                    arrayUnidad = [new _class_Instruccion__WEBPACK_IMPORTED_MODULE_7__["Instruccion"]("", new _class_tipo__WEBPACK_IMPORTED_MODULE_8__["Tipo"]('', 1), "", "", "", "")];
                else
                    arrayUnidad.push(new _class_Instruccion__WEBPACK_IMPORTED_MODULE_7__["Instruccion"]("", new _class_tipo__WEBPACK_IMPORTED_MODULE_8__["Tipo"]('', 1), "", "", "", ""));
            }
            for (let j = 0; j < this.celdas.tamano; j++) {
                if (arrayRob == undefined)
                    arrayRob = [new _class_Instruccion__WEBPACK_IMPORTED_MODULE_7__["Instruccion"]("", new _class_tipo__WEBPACK_IMPORTED_MODULE_8__["Tipo"]('', 1), "", "", "", "")];
                else
                    arrayRob.push(new _class_Instruccion__WEBPACK_IMPORTED_MODULE_7__["Instruccion"]("", new _class_tipo__WEBPACK_IMPORTED_MODULE_8__["Tipo"]('', 1), "", "", "", ""));
            }
            //--------------------------------------------------------------------------------------------------
            //--------------------------------------------------------------------------------------------------
            //--------------------------------------------------------------------------------------------------
            ...
            var despacho = this.despacho.tamano - 1;
            //se llena el despacho de derecha a izquierda
            ...
            while (!this.terminado(this.ciclos[actual].celdas.instrucciones, actual)) {
                            ...
                            if (this.ciclos[actual].celdas.instrucciones[j].cicloActual < this.ciclos[actual].celdas.instrucciones[j].tipo.ciclos) {
                                ...
                                if (this.ciclos[actual].celdas.instrucciones[j].cicloActual == this.ciclos[actual].celdas.instrucciones[j].tipo.ciclos) {
                                    ...
                                    if (nextEstacion != -1) {
                                        ...
                                        this.ciclos[actual].unidadesFuncionales.instrucciones[uf].name = '';
                                }
                            }
                        }
                    }
                ...
                for (let k = this.ciclos[actual].despacho.instrucciones.length - 1; k >= 0; k--) {
                    if (this.ciclos[actual].despacho.instrucciones[k].name != '') {
                        ...
                        if (this.puedoMeterlo(this.ciclos[actual].despacho.instrucciones[k]) == 'N')
                            ufEmpty = -1;
                        if (ufEmpty != -1) {
                            ...
                            if (erEmpty != -1) {
                                ...
                                if (this.ciclos[actual].despacho.instrucciones[k].name != '') {
                                    for (let m = 0; m < this.ciclos[actual].celdas.instrucciones.length; m++) {
                                        if ((this.ciclos[actual].celdas.instrucciones[m].estado == 'F') && (this.ciclos[actual].celdas.instrucciones[m].segundaInstruccion == null)
                                            && ((this.ciclos[actual - 1].celdas.instrucciones[m].estado != 'F'))) { //&& (this.puedoSacarlo(actual, m) == 'Y')) {
    ...
    //  }
    puedoMeterlo(arg0) {
        if ((arg0.tipo.name == 'ST') && (this.estaOcupado(arg0.name, arg0.reg1, arg0.regDest) == 'N'))
            return 'Y';
        else if ((arg0.tipo.name == 'LD') && (this.estaOcupado(arg0.name, arg0.reg1) == 'N'))
            return 'Y';
        else if (this.estaOcupado(arg0.name, arg0.reg1, arg0.reg2) == 'N')
            return 'Y';
        else
            return 'N';
    }
    estaOcupado(name, reg1, reg2) {
        ...
        if (reg2 != undefined) {
            ...
            if (this.registrosEstadoOcupado[numero2] == 'D' && this.registrosEstadoOcupado[numero] == 'D') {
                ...
                for (let l = 0; l < numeroInstruccion; l++) {
                    if ((this.instrucciones[l].regDest == reg1 || this.instrucciones[l].regDest == reg2) && (this.instrucciones[l].estado == 'I'))
                        return 'Y';
                }
                return 'N';
            }
        ...
        if (this.registrosEstadoOcupado[numero] == 'D') {
            ...
            var numeroInstruccion = +nombreInstruccion;
            for (let l = 0; l < numeroInstruccion; l++) {
                if (this.instrucciones[l].regDest == reg1 && this.instrucciones[l].estado == 'I')
                    return 'Y';
            }
            return 'N';
        }
    ...
    puedoSacarSegundaInstruccion(cicloActual, columna) {
        ...
        var numero = nombre.substr(1);
        var num = +numero;
        if (this.instrucciones[num - 1].estado == 'AFUERA')
            return 'Y';
        else {
            num = num - 1;
            nombre = 'S' + num;
            ...
            if (columnaCelda != -1)
                if (this.ciclos[cicloActual].celdas.instrucciones[columnaCelda].name == nombre) {
                    if (this.puedoSacarlo(cicloActual, columnaCelda) == 'Y')
                        return 'Y';
                }
                else if (this.puedoSacarSegundaInstruccion(cicloActual, columnaCelda) == 'Y')
                    return 'Y';
        }
        return 'N';
    }
...
RobComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'rob',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./rob.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/rob/rob.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./rob.component.scss */ "./src/app/rob/rob.component.scss")).default]
    })
    /** ROB component*/
], RobComponent);
...
module.exports = __webpack_require__(/*! C:\Users\lauta\AngularAppTypescript\src\main.ts */"./src/main.ts");
